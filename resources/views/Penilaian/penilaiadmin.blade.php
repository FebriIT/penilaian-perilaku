                                ...
                                <table id="datatable1" class="table table-striped table-bordered table-sm text-center"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->bawahan }}</td>
                                            <td>{{ $row->hasil }}</td>
                                            <td><a href="/admin/penilaian/{{ $row->nip_ygdinilai }}" class="tabledit-edit-button btn btn-sm btn-primary" style="float: none; margin: 5px;"><span class="ti-receipt"></span></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
